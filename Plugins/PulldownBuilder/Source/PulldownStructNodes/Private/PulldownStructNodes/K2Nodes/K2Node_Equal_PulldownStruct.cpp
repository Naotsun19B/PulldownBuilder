...
const FName UK2Node_Equal_PulldownStruct::LhsPinName = TEXT("Lhs");
const FName UK2Node_Equal_PulldownStruct::RhsPinName = TEXT("Rhs");

FText UK2Node_Equal_PulldownStruct::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
		...
		if (const UScriptStruct* ValueStruct = GetArgumentStructType())
		{
			if (CachedNodeTitle.IsOutOfDate(this))
			{
				CachedNodeTitle.SetCachedText(
					FText::Format(
						LOCTEXT("NodeTitleFormat", "Equal ({StructName})"),
	...
	return LOCTEXT("NodeTitle", "Equal (Pulldown Struct)");
}

void UK2Node_Equal_PulldownStruct::AllocateDefaultPins()
{
...
bool UK2Node_Equal_PulldownStruct::IsNodePure() const
{
	return true;
}

bool UK2Node_Equal_PulldownStruct::ShouldDrawCompact() const
{
	return true;
}

FText UK2Node_Equal_PulldownStruct::GetCompactNodeTitle() const
{
	return LOCTEXT("CompactNodeTitle", "==");
}

FText UK2Node_Equal_PulldownStruct::GetMenuCategory() const
{
	return LOCTEXT("MenuCategory", "Pulldown Struct");
}

void UK2Node_Equal_PulldownStruct::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UK2Node_Equal_PulldownStruct::ExpandNode(FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	Super::ExpandNode(CompilerContext, SourceGraph);

	const FName FunctionName = GET_FUNCTION_NAME_CHECKED(UPulldownStructFunctionLibrary, Equal_PulldownStruct);
	...
	{
		FunctionNode->FunctionReference.SetExternalMember(FunctionName, UPulldownStructFunctionLibrary::StaticClass());
...
void UK2Node_Equal_PulldownStruct::PostReconstructNode()
{
...
void UK2Node_Equal_PulldownStruct::NotifyPinConnectionListChanged(UEdGraphPin* Pin)
{
...
bool UK2Node_Equal_PulldownStruct::IsConnectionDisallowed(const UEdGraphPin* MyPin, const UEdGraphPin* OtherPin, FString& OutReason) const
{
...
UEdGraphPin* UK2Node_Equal_PulldownStruct::GetLhsPin() const
{
...
UEdGraphPin* UK2Node_Equal_PulldownStruct::GetRhsPin() const
{
...
UEdGraphPin* UK2Node_Equal_PulldownStruct::GetReturnValuePin() const
{
...
void UK2Node_Equal_PulldownStruct::EnumerateArgumentPins(const TFunction<bool(UEdGraphPin& ArgumentPin)>& Predicate) const
{
...
UScriptStruct* UK2Node_Equal_PulldownStruct::GetArgumentStructType() const
{
...
void UK2Node_Equal_PulldownStruct::RefreshArgumentStructType()
{
