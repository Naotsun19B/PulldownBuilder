...
TSharedPtr<FString> FPreviewPulldownStructDetail::FindDisplayStringByName(const FName& InName) const
{
...
void FPreviewPulldownStructDetail::OnStateValueChanged(TSharedPtr<FString> SelectedItem, ESelectInfo::Type SelectInfo)
{
